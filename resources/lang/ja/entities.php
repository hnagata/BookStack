...
return [
    ...
    'recently_created_shelves' => '最近作成されたシェルフ',
    ...
    'permissions' => '権限',
    'permissions_intro' => 'この設定は各ユーザのロールよりも優先して適用されます。',
    ...
    'shelf' => 'シェルフ',
    'shelves' => 'シェルフ',
    'x_shelves' => ':count シェルフ',
    'shelves_long' => 'シェルフ',
    'shelves_empty' => 'まだシェルフは作成されていません',
    'shelves_create' => '新しいシェルフを作成する',
    'shelves_popular' => '人気のシェルフ',
    'shelves_new' => '新しいシェルフ',
    'shelves_new_action' => '新しいシェルフ',
    'shelves_popular_empty' => 'ここに人気のシェルフが表示されます。',
    'shelves_new_empty' => 'ここに最近更新されたシェルフが表示されます。',
    'shelves_save' => 'シェルフを保存',
    'shelves_books' => 'シェルフにあるブック',
    'shelves_add_books' => 'このシェルフにブックを追加する',
    'shelves_drag_books' => 'ブックをドラッグしてこのシェルフに追加できます',
    'shelves_empty_contents' => 'このシェルフにはブックがありません',
    'shelves_edit_and_assign' => 'シェルフを編集してブックを割り当てる',
    'shelves_edit_named' => 'シェルフ「:name」を編集',
    'shelves_edit' => 'シェルフを編集',
    'shelves_delete' => 'シェルフを削除',
    'shelves_delete_named' => 'シェルフ「:name」を削除',
    'shelves_delete_explain' => "「':name'」を削除します。シェルフ内のブックは削除されません。",
    'shelves_delete_confirmation' => '本当にこのシェルフを削除してよろしいですか？',
    'shelves_permissions' => 'シェルフの権限',
    'shelves_permissions_updated' => 'シェルフの権限を更新しました',
    'shelves_permissions_active' => 'シェルフの権限は有効です',
    'shelves_copy_permissions_to_books' => 'ブックに権限をコピー',
    'shelves_copy_permissions' => '権限をコピー',
    'shelves_copy_permissions_explain' => 'シェルフ内のすべてのブックに、現在のシェルフの権限を適用します。有効にする前に、シェルフの権限の設定がすべて保存されていることを確認してください。',
    'shelves_copy_permission_success' => ':count ブックにシェルフの権限がコピーされました',
    ...
    'books_new_empty' => 'ここに最近更新されたブックが表示されます。',
    ...
    'books_sort_name' => '名前でソート',
    'books_sort_created' => '作成日でソート',
    'books_sort_updated' => '更新日でソート',
    'books_sort_chapters_first' => 'チャプターを前に',
    ...
    'pages_revisions_numbered_changes' => 'リビジョン #:id 変更点',
    ...
    'pages_is_template' => 'テンプレート',

    // Editor Sidebar
    'page_tags' => 'タグ',
    'chapter_tags' => 'チャプタータグ',
    'book_tags' => 'ブックタグ',
    'shelf_tags' => 'シェルフタグ',
    'tag' => 'タグ',
    'tags' =>  'タグ',
    ...
    'templates' => 'テンプレート',
    'templates_set_as_template' => 'このページはテンプレートです',
    'templates_explain_set_as_template' => 'このページをテンプレートに指定すると、他のページの作成に利用できます。他のユーザも、表示権限があればこのテンプレートを利用できます。',
    'templates_replace_content' => 'ページ内容を置換',
    'templates_append_content' => 'ページ内容の後に追加',
    'templates_prepend_content' => 'ページ内容の前に追加',
    ...
    'profile_not_created_shelves' => ':userNameはシェルフを作成していません',
    ...
    'revision_restore_confirm' => 'このリビジョンを復元しますか？現在のページ内容が置換されます。',
